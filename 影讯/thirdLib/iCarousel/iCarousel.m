...
- (void)transformItemView:(UIView *)view atIndex:(NSInteger)index
{
    ...
    view.superview.layer.shadowOffset = CGSizeMake(0,2);//0,2
    view.superview.layer.shadowRadius = 3.0;
    view.superview.layer.shadowColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:1].CGColor;
    view.superview.layer.shadowOpacity = 0.6f;
